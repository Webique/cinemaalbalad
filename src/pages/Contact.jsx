...
export default function Contact() {
  ...
  return (
    <>
      <Navbar />
      <main className="pt-36 bg-gradient-to-b from-secondary via-black to-secondary text-white font-cinema min-h-screen px-6 sm:px-10 lg:px-20 pb-32">
        <motion.section
        ...
        >
          ...
          <motion.form
            ...
            className="bg-white/5 p-8 sm:p-10 rounded-xl backdrop-blur-md shadow-xl space-y-6 text-left"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
